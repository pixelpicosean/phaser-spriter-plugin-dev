export function load_bool(json, key, def = false) {
...
export function load_float(json, key, def = 0) {
    const value = json[key]
    switch (typeof(value)) {
...
export function load_int(json, key, def = 0) {
    const value = json[key]
    switch (typeof(value)) {
...
export function load_string(json, key, def = '') {
    const value = json[key]
    switch (typeof(value)) {
...
function interpolate_quadratic(a, b, c, t) {
    return interpolate_linear(interpolate_linear(a, b, t), interpolate_linear(b, c, t), t)
}

function interpolate_cubic(a, b, c, d, t) {
    return interpolate_linear(interpolate_quadratic(a, b, c, t), interpolate_quadratic(b, c, d, t), t)
}

function interpolate_quartic(a, b, c, d, e, t) {
    return interpolate_linear(interpolate_cubic(a, b, c, d, t), interpolate_cubic(b, c, d, e, t), t)
}

function interpolate_quintic(a, b, c, d, e, f, t) {
    return interpolate_linear(interpolate_quartic(a, b, c, d, e, t), interpolate_quartic(b, c, d, e, f, t), t)
}

function interpolate_bezier(x1, y1, x2, y2, t) {
...
export function wrap_angle_radians(angle) {
    if (angle <= 0.0) {
...
export function tween_angle_radians(a, b, t, spin) {
    if (spin === 0) {
        return a
    } else if (spin > 0) {
        if ((b - a) < 0.0) {
    ...
    return wrap_angle_radians(a + (wrap_angle_radians(b - a) * t))
}
...
export class Angle {
    ...
    self_add(other) { return Angle.add(this, other, this) }
    tween(other, pct, spin, out = new Angle()) {
        return Angle.tween(this, other, pct, spin, out)
    }
    self_tween(other, pct, spin) {
        return Angle.tween(this, other, pct, spin, this)
    }
}
Angle.add = function(a, b, out = new Angle()) {
    out.rad = wrap_angle_radians(a.rad + b.rad)
    return out
}
Angle.tween = function(a, b, pct, spin, out = new Angle()) {
    out.rad = tween_angle_radians(a.rad, b.rad, pct, spin)
    return out
}
...
export class Space {
    ...
    load(json) {
        ...
        space.rotation.deg = load_float(json, 'angle', 0.0)
...
Space.rotate = function(space, rad) {
    space.rotation.rad = wrap_angle_radians(space.rotation.rad + rad)
    return space
}
...
Space.combine = function(a, b, out) {
    ...
    if ((a.scale.x * a.scale.y) < 0.0) {
        out.rotation.rad = wrap_angle_radians(a.rotation.rad - b.rotation.rad)
    } else {
        out.rotation.rad = wrap_angle_radians(b.rotation.rad + a.rotation.rad)
    }
...
Space.extract = function(ab, a, out) {
    ...
    if ((a.scale.x * a.scale.y) < 0.0) {
        out.rotation.rad = wrap_angle_radians(a.rotation.rad + ab.rotation.rad)
    } else {
        out.rotation.rad = wrap_angle_radians(ab.rotation.rad - a.rotation.rad)
    }
...
Space.tween = function(a, b, pct, spin, out) {
    ...
    out.rotation.rad = tween_angle_radians(a.rotation.rad, b.rotation.rad, pct, spin)
...
export class Element {
    ...
    load(json) {
        this.id = load_int(json, 'id', -1)
        this.name = load_string(json, 'name', "")
        return this
    }
}
...
export class File extends Element {
    ...
    load(json) {
        super.load(json)
        const type = load_string(json, 'type', "image")
...
export class ImageFile extends File {
    ...
    load(json) {
        super.load(json)
        this.width = load_int(json, 'width', 0)
        this.height = load_int(json, 'height', 0)
        this.pivot.x = load_float(json, 'pivot_x', 0.0)
        this.pivot.y = load_float(json, 'pivot_y', 0.0)
        return this
    }
}
...
export class Folder extends Element {
    ...
    load(json) {
        super.load(json)
        this.file_array = []
        json.file = make_array(json.file)
...
export class BaseObject {
    ...
    load(json) {
        const type = load_string(json, 'type', "sprite")
        if (this.type !== type) throw new Error()
        return this
    }
}
...
export class SpriteObject extends BaseObject {
    ...
    load(json) {
        super.load(json)
        this.parent_index = load_int(json, 'parent', -1)
        this.folder_index = load_int(json, 'folder', -1)
        this.file_index = load_int(json, 'file', -1)
        ...
        this.z_index = load_int(json, 'z_index', 0)
        this.alpha = load_float(json, 'a', 1.0)
        return this
    }
    copy(other) {
...
export class SoundObject extends BaseObject {
    ...
    load(json) {
        ...
        this.folder_index = load_int(json, 'folder', -1)
        this.file_index = load_int(json, 'file', -1)
        this.trigger = load_bool(json, 'trigger', false)
        this.volume = load_float(json, 'volume', 1.0)
        this.panning = load_float(json, 'panning', 0.0)
        return this
    }
    copy(other) {
        this.folder_index = other.folder_index
...
export class EntityObject extends BaseObject {
    ...
    load(json) {
        ...
        this.local_space.load(json)
        this.world_space.copy(this.local_space)
        this.entity_index = load_int(json, 'entity', -1)
        this.animation_index = load_int(json, 'animation', -1)
        this.animation_time = load_float(json, 't', 0.0)
        return this
    }
    copy(other) {
        this.parent_index = other.parent_index
...
export class Ref extends Element {
    ...
    load(json) {
        super.load(json)
        this.parent_index = load_int(json, 'parent', -1)
        this.timeline_index = load_int(json, 'timeline', -1)
        this.keyframe_index = load_int(json, 'key', -1)
        return this
    }
}
...
export class Keyframe extends Element {
    ...
    load(json) {
        super.load(json)
        this.time = load_int(json, 'time', 0)
        return this
    }
}
...
export class Curve {
    ...
    load(json) {
        this.type = load_string(json, 'curve_type', "linear")
        this.c1 = load_float(json, 'c1', 0.0)
        this.c2 = load_float(json, 'c2', 0.0)
        this.c3 = load_float(json, 'c3', 0.0)
        this.c4 = load_float(json, 'c4', 0.0)
        return this
    }
    evaluate(t) {
        switch (this.type) {
        ...
        case "quadratic": return interpolate_quadratic(0.0, this.c1, 1.0, t)
        case "cubic": return interpolate_cubic(0.0, this.c1, this.c2, 1.0, t)
        case "quartic": return interpolate_quartic(0.0, this.c1, this.c2, this.c3, 1.0, t)
        case "quintic": return interpolate_quintic(0.0, this.c1, this.c2, this.c3, this.c4, 1.0, t)
        case "bezier": return interpolate_bezier(this.c1, this.c2, this.c3, this.c4, t)
        }
        return 0.0
    }
}
...
export class MainlineKeyframe extends Keyframe {
    ...
    load(json) {
        ...
        json.bone_ref = make_array(json.bone_ref)
        ...
        json.object_ref = make_array(json.object_ref)
...
export class TimelineKeyframe extends Keyframe {
    ...
    load(json) {
        ...
        // const type = load_string(json, 'type', "sprite")
        // if (this.type !== type) throw new Error()
        this.spin = load_int(json, 'spin', 1)
...
export class Tag extends Element {
    ...
    load(json) {
        super.load(json)
        this.tag_def_index = load_int(json, 't', -1)
        return this
    }
}
...
export class VarlineKeyframe extends Keyframe {
    ...
    load(json) {
        ...
        case 'number':
            varline_keyframe.val = load_float(json, 'val', 0.0)
            break
        case 'string':
            varline_keyframe.val = load_string(json, 'val', "")
            break
        }
        return this
    }
...
export class Varline extends Element {
    ...
    load(json) {
        super.load(json)
        const varline = this
        varline.var_def_index = load_int(json, 'def', -1)
...
export class Meta extends Element {
    ...
    load(json) {
        ...
        if (json.varline) {
            json.varline = make_array(json.varline)
...
export class Timeline extends Element {
    ...
    load(json) {
        super.load(json)
        const timeline = this
        timeline.type = load_string(json, 'object_type', "sprite")
        timeline.object_index = load_int(json, 'obj', -1)
...
export class MapInstruction {
    ...
    load(json) {
        ...
        map_instruction.folder_index = load_int(json, 'folder', -1)
        map_instruction.file_index = load_int(json, 'file', -1)
        map_instruction.target_folder_index = load_int(json, 'target_folder', -1)
        map_instruction.target_file_index = load_int(json, 'target_file', -1)
        return this
    }
}
...
export class VarDef extends Element {
    ...
    load(json) {
        super.load(json)
        this.type = this.default_value = load_string(json, 'type', "")
        switch (this.type) {
            case 'int':
            this.value = this.default_value = load_int(json, 'default_value', 0)
            break
            case 'float':
            this.value = this.default_value = load_float(json, 'default_value', 0.0)
            break
            case 'string':
            this.value = this.default_value = load_string(json, 'default_value', "")
            break
        }
        return this
    }
...
export class ObjInfo extends Element {
    ...
    load(json) {
        super.load(json)
        // const type = load_string(json, 'type', "unknown")
        // if (this.type !== type) throw new Error()
...
export class SpriteObjInfo extends ObjInfo {
    ...
    load(json) {
        ...
        json.frames = make_array(json.frames)
...
export class BoneObjInfo extends ObjInfo {
    ...
    load(json) {
        super.load(json);
        this.w = load_int(json, 'w', 0)
        this.h = load_int(json, 'h', 0)
        return this
    }
}
...
export class Animation extends Element {
    ...
    load(json) {
        super.load(json)
        const anim = this
        anim.length = load_int(json, 'length', 0)
        anim.looping = load_string(json, 'looping', "true")
        anim.loop_to = load_int(json, 'loop_to', 0)
        anim.mainline = new Mainline().load(json.mainline || {})
        anim.timeline_array = []
        json.timeline = make_array(json.timeline)
        json.timeline.forEach(function(timeline_json) {
            anim.timeline_array.push(new Timeline().load(timeline_json))
        })
        anim.soundline_array = []
        json.soundline = make_array(json.soundline)
        ...
        json.eventline = make_array(json.eventline)
...
export class Entity extends Element {
    ...
    load(json) {
        ...
        json.character_map = make_array(json.character_map)
        ...
        json.obj_info = make_array(json.obj_info)
        ...
        json.animation = make_array(json.animation)
...
export class Data {
    ...
    load(json) {
        const data = this
        const scon_version = load_string(json, 'scon_version', "")
        const generator = load_string(json, 'generator', "")
        const generator_version = load_string(json, 'generator_version', "")
        data.folder_array = []
        json.folder = make_array(json.folder)
        json.folder.forEach(function(folder_json) {
            data.folder_array.push(new Folder().load(folder_json))
        })
        data.tag_def_array = []
        json.tag_list = make_array(json.tag_list)
        json.tag_list.forEach(function(tag_list_json) {
            data.tag_def_array.push(new TagDef().load(tag_list_json))
        })
        data.entity_map = {}
        data.entity_keys = []
        json.entity = make_array(json.entity)
    ...
    get_entities() { return this.entity_map }
    get_entity_keys() { return this.entity_keys }
    get_anims(entity_key) {
...
export class Pose {
    ...
    get_entities() {
        if (this.data) {
            return this.data.get_entities()
        }
        return null
    }
    get_entity_keys() {
        if (this.data) {
            return this.data.get_entity_keys()
        }
        return null
    }
    get_current_entity_key() {
    ...
    get_anims() {
        if (this.data) {
            return this.data.get_anims(this.entity_key)
        }
        return null
    }
    get_anim_keys() {
        if (this.data) {
            return this.data.get_anim_keys(this.entity_key)
        }
        return null
    }
    get_current_anim_key() {
        return this.anim_key
    }
    get_current_anim() {
        const anims = this.get_anims()
        return anims && anims[this.anim_key]
    }
    get_current_anim_length() {
        const pose = this
    ...
    set_current_anim(anim_key) {
        if (this.anim_key !== anim_key) {
            this.anim_key = anim_key
            const anim = this.get_current_anim()
            if (anim) {
    ...
    strike() {
        ...
        const entity = pose.get_current_entity()
        ...
        const anim = pose.get_current_anim()
        ...
        if (anim) {
            ...
            pose_object_array.forEach(function(object) {
                ...
                case 'entity':
                    ...
                    if (sub_entity_key !== sub_pose.get_current_entity_key()) {
                        sub_pose.set_current_entity(sub_entity_key)
                    }
                    const sub_entity = sub_pose.get_current_entity()
                    const sub_anim_key = sub_entity.animation_keys[entity_object.animation_index]
                    if (sub_anim_key !== sub_pose.get_current_anim_key()) {
                        sub_pose.set_current_anim(sub_anim_key)
                        const anim_length = sub_pose.get_current_anim_length()
                        const sub_time = entity_object.animation_time * anim_length
                        sub_pose.set_time(sub_time)
                    } else {
                        const anim_length = sub_pose.get_current_anim_length()
                        const sub_time = entity_object.animation_time * anim_length
                        const sub_dt = sub_time - sub_pose.get_time()
